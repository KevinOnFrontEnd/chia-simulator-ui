                ...
                <table className="table-auto w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        {parsedParams.length > 0 ? (
                                    ...
                                    <td className="border border-gray-300 px-4 py-2 truncate">
                                        {param.type === "Address" ? (
                                            <div className="flex flex-col text-left">
                                                <div><strong>Address:</strong> {param.originalValue}</div>
                                                <div className="text-gray-400 text-sm"><strong>Puzzle Hash:</strong> {param.puzzleHashHex}</div>
                                            </div>
                                        ) : (
                                            param.displayValue ?? ""
                                        )}
                            ...
                            <tr>
                                <td colSpan="3" className="border border-gray-300 px-4 py-2 text-center text-gray-500 italic">
